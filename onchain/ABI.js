const ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "passCardAddress", type: "address" },
    ],
  ...
  { inputs: [], name: "ZeroAddress", type: "error" },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "new_checkIn_amount", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "new_buyPass_amount", type: "uint256" },
    ],
    name: "ActionValuesChanged",
    type: "event",
  },
  {
    anonymous: false,
  ...
  { anonymous: false, inputs: [{ indexed: true, internalType: "address", name: "new_passCardAddress", type: "address" }], name: "PassCardAddressChanged", type: "event" },
  ...
  { inputs: [], name: "buyPass", outputs: [], stateMutability: "payable", type: "function" },
  { inputs: [], name: "buyPassUSDT", outputs: [], stateMutability: "nonpayable", type: "function" },
  ...
  { inputs: [], name: "getActionValues", outputs: [{ internalType: "uint256[2]", name: "", type: "uint256[2]" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "getBuyPassAmount", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "getBuyPassAmountUSDT", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [], name: "getPassCardAddress", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "uint256[2]", name: "new_actionValues", type: "uint256[2]" }], name: "setActionValues", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ internalType: "address", name: "new_owner", type: "address" }], name: "setOwner", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ internalType: "address", name: "new_passCardAddress", type: "address" }], name: "setPassCardAddress", outputs: [], stateMutability: "nonpayable", type: "function" },
